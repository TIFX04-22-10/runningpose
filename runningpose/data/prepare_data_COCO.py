...
__all__ = ['INFO', 'LICENSES', 'CATEGORIES', 'parse_args', 'main']
    ...
    for video_name in im_list:
        ...
        for frame_i, im in enumerate(infer_video.read_video(video_name)):
            ...
            if outputs.has("pred_boxes") and len(outputs) == 1:
                ...
                # TODO: Sätt in keypoints här, läs in från fil.
                annotation_info = pycoco.create_annotation_info(annotation_id, image_id, pred_masks_tensor, bbox_tensor)
