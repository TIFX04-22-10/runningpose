# AUTOGENERATED! DO NOT EDIT! File to edit: 08_generators.ipynb (unless otherwise specified).
...
class ChunkedGenerator:
    ...
    """
    def __init__(self, batch_size, cameras, poses_3d, poses_2d, chunk_length, pad=0, causal_shift=0, shuffle=True,
                 random_seed=47, augment=False, kps_left=None, kps_right=None, joints_left=None, joints_right=None, endless=False):
        ...
        def next_epoch(self):
            """
            Sets up the next forward pass + backward pass for all the training samples.
            ...
            while enabled:
                ...
                for batch_index in range(start_idx, self.num_batches):
                    chunks = pairs[batch_index*batch_size : (batch_index+1)*self.batch_size]
                    for i, (seq_idx, start_3d, end_3d, flip) in enumerate(chunks):
                        ...
                        if flip:
                            # Flip 2D keypoints
                            self.batch_2d[i, :, :, 0] *= -1
                            self.batch_2d[i, :, self.kps_left + self.kps_right] \
                                        = self.batch_2d[i, :, self.kps_right + self.kps_left]
...
class UnchunkedGenerator:
    ...
    def next_epoch(self):
        ...
        for seq_cam, seq_3d, seq_2d in zip_longest(self.cameras, self.poses_3d, self.poses_2d):
            ...
            a, b = self.pad + self.causal_shift, self.pad - self.causal_shift # a and b are help variables only.
            batch_2d = np.expand_dims(np.pad(seq_2d,((a, b), (0, 0), (0, 0)), 'edge'), axis=0)
